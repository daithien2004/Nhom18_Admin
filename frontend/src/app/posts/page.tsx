...
export default function PostsManagementPage() {
  ...
  const loading = isLoading || hiding || unhiding || deleting || updating;
  ...
  const submitEdit = async () => {
    if (!editingId) return;
    const t = toast.loading("Cập nhật bài đăng...");
    try {
      await updatePost({
        id: editingId,
        content: editContent,
      ...
      toast.error(error?.data?.message || "Cập nhật thất bại", { id: t });
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <PostsTable
          ...
          loadingStates={{ updating, hiding, unhiding, deleting }}
        />
        <Pagination
