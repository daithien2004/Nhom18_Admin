            ...
            return (
              <tr key={id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right w-52 space-x-1">
                  <button
                    onClick={() => onBanToggle(id, u.isBanned)}
                  ...
                  <button
                    onClick={() => onVerifyToggle(id, u.isVerified)}
                  ...
                  <button
                    ...
                    disabled={resetting}
                    className="w-24 h-8 px-1 text-xs rounded font-medium bg-gray-700 text-white transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:bg-gray-800"
                  >
                    Đổi mật khẩu
                  </button>
                </td>
